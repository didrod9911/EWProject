...
public class EWgameframe2 extends JFrame implements Runnable {
	...
	public EWgameframe2(Socket s1, DataOutputStream outputStream, DataInputStream inputStream,
		...
		label_1.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/cline.png")));
		label_1.setBounds(500, 170, 110, 50);
		contentPane.add(label_1);
		
		JLabel label = new JLabel("");
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/bline2.png")));
		label.setBounds(260, 170, 110, 50);
		contentPane.add(label);
		
		JLabel label_2 = new JLabel("");
		label_2.setHorizontalAlignment(SwingConstants.CENTER);
		label_2.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/bline2.png")));
		...
		for(int i=0; i<this.members.length; i++) {
			if(this.members[i] != null) {
				...
				if(location == 1) {
					img01.setIcon(new ImageIcon(EWgameframe2.class.getResource(avatarImage)));
					nickname01.setText(this.members[i].getNickname());
				}
				if(location == 2) {
					img02.setIcon(new ImageIcon(EWgameframe2.class.getResource(avatarImage)));
					nickname02.setText(this.members[i].getNickname());
				}
				if(location == 3) {
					img03.setIcon(new ImageIcon(EWgameframe2.class.getResource(avatarImage)));
					nickname03.setText(this.members[i].getNickname());
				}
				if(location == 4) {
					img04.setIcon(new ImageIcon(EWgameframe2.class.getResource(avatarImage)));
					nickname04.setText(this.members[i].getNickname());
				}
				if(location == 5) {
					img05.setIcon(new ImageIcon(EWgameframe2.class.getResource(avatarImage)));
					nickname05.setText(this.members[i].getNickname());
				}
				if(location == 6) {
					img06.setIcon(new ImageIcon(EWgameframe2.class.getResource(avatarImage)));
			...
			while(inputStream != null){
				...
				if(signal == 7) {
					...
					t2.schedule(new TimerTask() {
						@Override
						public void run() {
							lblNewLabel.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/incorrect.png")));							
				...
				if(signal == 9) {
					...
					//탈락자 탈락이미지 처리
					if(retireUserNum == 1) {
						img01.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/retire.png")));
					}
					if(retireUserNum == 2) {
						img02.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/retire.png")));
					}
					if(retireUserNum == 3) {
						img03.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/retire.png")));
					}
					if(retireUserNum == 4) {
						img04.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/retire.png")));
					}
					if(retireUserNum == 5) {
						img05.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/retire.png")));
					}
					if(retireUserNum == 6) {
						img06.setIcon(new ImageIcon(EWgameframe2.class.getResource("/image/retire.png")));
					}
