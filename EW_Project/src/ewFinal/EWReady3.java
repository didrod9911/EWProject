...
public class EWReady3 extends JFrame implements Runnable, ActionListener {
	...
	public EWReady3(Socket s1, DataOutputStream outputStream, DataInputStream inputStream) throws IOException {	
		this.s1 = s1;
	...
	public void show(int location, String nickname, int avatarnum, boolean ready) {
		...
		case 1:
			...
			if(avatarnum != -1) {
				img01.setIcon(new ImageIcon(EWReady3.class.getResource(img[avatarnum - 1])));
		...
		case 2:
			if(avatarnum != -1) {
				img02.setIcon(new ImageIcon(EWReady3.class.getResource(img[avatarnum - 1])));
		...
		case 3:
			if(avatarnum != -1) {
				img03.setIcon(new ImageIcon(EWReady3.class.getResource(img[avatarnum - 1])));
		...
		case 4:
			if(avatarnum != -1) {
				img04.setIcon(new ImageIcon(EWReady3.class.getResource(img[avatarnum - 1])));
		...
		case 5:
			if(avatarnum != -1) {
				img05.setIcon(new ImageIcon(EWReady3.class.getResource(img[avatarnum - 1])));
		...
		case 6:
			if(avatarnum != -1) {
				img06.setIcon(new ImageIcon(EWReady3.class.getResource(img[avatarnum - 1])));
